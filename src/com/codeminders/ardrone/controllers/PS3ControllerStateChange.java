...
public class PS3ControllerStateChange extends PS3ControllerState {
	...
	public PS3ControllerStateChange(PS3ControllerState o, PS3ControllerState n) {
		...
		buttonStateChanged = squareChanged || crossChanged || circleChanged || triangleChanged || L1Changed || R1Changed || L2Changed || R2Changed || selectChanged || startChanged || leftJoystickPressChanged || rightJoystickPressChanged || PSChanged;
