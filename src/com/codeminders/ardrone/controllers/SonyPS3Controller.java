...
public class SonyPS3Controller extends PS3Controller {
	...
	public PS3ControllerState read() throws IOException {
		...
		PS3ControllerState res = new PS3ControllerState(square, cross, circle, triangle, L1, R1, L2, R2, select, start, leftJoystickPress, rightJoystickPress, PS, hatSwitchLeftRight, hatSwitchUpDown, leftJoystickX, leftJoystickY, rightJoystickX, rightJoystickY);
